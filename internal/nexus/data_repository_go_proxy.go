...
var _ datasource.DataSource = &RepositoryGoProxyDatasource{}

func NewRepositoryGoProxyDatasource() datasource.DataSource {
	return &RepositoryGoProxyDatasource{}
}

type RepositoryGoProxyDatasource struct {
	client *nexus3.NexusClient
}

func (d *RepositoryGoProxyDatasource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_repository_go_proxy"
}

func (d *RepositoryGoProxyDatasource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *RepositoryGoProxyDatasource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *RepositoryGoProxyDatasource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state model.RepositoryGoProxyModel
...
func (d *RepositoryGoProxyDatasource) getState(name string) (data model.RepositoryGoProxyModel, err error) {
	...
	repo, err := d.client.Repository.Go.Proxy.Get(name)
	if err != nil {
		return
	}
	data = model.RepositoryGoProxyModel{
